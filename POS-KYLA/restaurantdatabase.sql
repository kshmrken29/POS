...
--
-- Host: 127.0.0.1
-- Generation Time: May 07, 2025 at 08:48 AM
...
('root', '[{\"db\":\"restaurantpos\",\"table\":\"cashiers\"},{\"db\":\"restaurantpos\",\"table\":\"inventory_items\"},{\"db\":\"restaurantpos\",\"table\":\"inventory_purchases\"},{\"db\":\"restaurantpos\",\"table\":\"inventory_usage\"},{\"db\":\"restaurantpos\",\"table\":\"menu_items\"},{\"db\":\"restaurantpos\",\"table\":\"sales\"},{\"db\":\"restaurantpos\",\"table\":\"sales_items\"},{\"db\":\"restaurantpos\",\"table\":\"transactions\"},{\"db\":\"restaurantpos\",\"table\":\"transaction_items\"},{\"db\":\"restaurantpos\",\"table\":\"users\"}]');
...
('root', '2025-05-07 06:36:02', '{\"Console\\/Mode\":\"collapse\"}');
...
(1, 'admin', '$2y$10$FzJbhR0uVSHZ0CX70XzVkOo96/LbBbcaUseaKHXQ/lESBIjcxyIEC', 'admin', '2025-05-07 14:45:06', '2025-05-07 06:11:05'),
...
--
-- Database: `restaurantpos1`
--
CREATE DATABASE IF NOT EXISTS `restaurantpos1` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `restaurantpos1`;
--
-- Database: `test`
--
