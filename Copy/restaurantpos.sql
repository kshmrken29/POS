...
--
-- Table structure for table `menu_inventory_mapping`
--
...
-- Add some sample data for menu-inventory relationships
INSERT INTO `menu_inventory_mapping` (`id`, `menu_item_id`, `inventory_item_id`, `quantity_per_serving`) VALUES
(1, 2, 5, 1.00),
(2, 4, 6, 2.50),
(3, 5, 7, 1.00);
...
--
-- Constraints for table `menu_inventory_mapping`
--
ALTER TABLE `menu_inventory_mapping`
  ADD CONSTRAINT `menu_inventory_mapping_ibfk_1` FOREIGN KEY (`menu_item_id`) REFERENCES `menu_items` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `menu_inventory_mapping_ibfk_2` FOREIGN KEY (`inventory_item_id`) REFERENCES `inventory_items` (`id`) ON DELETE CASCADE;
